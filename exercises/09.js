...
//    Use the OR operator (||), not the nullish operator, for the fallback.
//    The nullish operator only falls back on null/undefined, so an empty
//    string tagline would remain "" instead of becoming "No tagline". OR falls
//    back on any falsy value (null, undefined, empty string, 0, false), which
